...
@Client.on_message(filters.command(["channelpause","cpause","القناه توقف","القناة توقف"]) & filters.group & ~filters.edited)
@errors
...
@Client.on_message(filters.command(["channelresume","cresume","القناه استئناف","القناة استئناف"]) & filters.group & ~filters.edited)
@errors
@authorized_users_only
...
@Client.on_message(filters.command(["channelend","cend","القناه انهاء","القناة انهاء"]) & filters.group & ~filters.edited)
@errors
@authorized_users_only
...
@Client.on_message(filters.command(["channelskip","cskip","القناه تخطي","القناة تخطي"]) & filters.group & ~filters.edited)
@errors
@authorized_users_only
...
@Client.on_message(filters.command(["channelupdata","cupdata","القناه تحديث","القناة تحديث"]) & filters.group & ~filters.edited)
@errors
