...
class Messages():
      ...
      HELP_MSG = [
        ".",
f"""
**مرحبًا 👋 بك مرة أخرى [{}](tg://user?id={})
⚪️ يمكنه تشغيل الموسيقى في الدردشة الصوتية لمجموعتك بالإضافة إلى الدردشات الصوتية للقناة ايضا
⚪️ الحساب المساعد >> @{ASSISTANT_NAME}\n\nانقر علي الزر لي مشاهدة الاوامر**
""",
...
**الاوامر**
**=>> تشغيل موسيقي 🎧**
- /تشغيل [اسم الموسيقي]: لي تشغيل موسيقي
...
f"""
**=>> مزيد من الادوات 🧑‍🔧**
- /musicplayer [on/off]: تعطيل/تفعيل : البوت
...
**=>> اوامر المطورين ⚔️**
 ...
 - /pmpermit [on/off] - تعطيل/تفعيل رد الخاص
