...
*) اذي انضم الحساب المساعد استمتع بي الموسيقي اذي (لم ينضم فا اضفه يدويا @{user.username})
...
- /cdplay [اسم الموسيقي] - لي تشغيل موسيقي من الديزر
...
f"""
**=>> مزيد من الادوات 🧑‍🔧**
- /musicplayer [on/off]: تفعيل/تعطيل : لي تفعيل و تعطيل مشغل الموسيقي
- /تحديث: لي تحديث قائمه المشرفين في المجموعه
- /انضم: لي دعوه الحساب المساعد الي المجموعه @{user.username}
- /تحميل: لي تحميل اغنية من يوتيوب
**=>> اوامر المطورين ⚔️**
 - /مغادره - لي مغادره الحساب المساعد من جميع الدردشات
 - /اذاعه المساعد <بي الرد علي رساله> - يقوم الحساب المساعد بي ارساله لي جميع المحادثات
